...
*/
	...
	*/ 
	...
	$config['database']['user_acc']['columns']['date_added'] = 'uacc_date_added';
        //aca modifique
        $config['database']['user_acc']['columns']['identificacion'] = 'uacc_identificacion';
	...
	$config['database']['user_acc']['custom_columns'] = array(
        ...
        //$config['database']['user_acc']['custom_columns'] = array('uacc_identificacion'); 
	...
	*/ 
	...
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'upro_first_name','upro_last_name','upro_phone','upro_newsletter','upro_codigo','upro_programa','upro_sede'
	);
	...
	*/
	...
	//$config['database']['settings']['identity_cols'] = array('uacc_email', 'uacc_username','uacc_identificacion');
	...
	*/
	$config['security']['recaptcha_public_key']	= '6LeS3_wSAAAAAEhL6vm65x5I-yQ1FPRHjF_q5Qic';
	$config['security']['recaptcha_private_key'] = '6LeS3_wSAAAAAJ181sxElf1UqP5unEpV14AuUKfC'; 
	...
	*/
	...
	$config['messages']['delimiters']['status_prefix'] = '<div class="ui positive message">';
	
	// Message End Delimiter
	$config['messages']['delimiters']['status_suffix'] = '</div>';
	
	// Error Start Delimiter
	$config['messages']['delimiters']['error_prefix'] = '<div class="ui negative message">';
